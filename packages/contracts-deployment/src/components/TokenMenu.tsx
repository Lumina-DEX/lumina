			...
			>
				<Box sx={style}>
					<div className="flex flex-row">
						<input
							type="text"
							className="w-full mb-3 border border-indigo-600 p-1"
						...
						{virtualList.map((x) => (
							...
							>
								<div className="flex flex-row justify-between">
									...
									{!x.approved && (
										<span
											title="This pool has not yet been listed and was created by an external user, so please take precautions before trading on this pool."
