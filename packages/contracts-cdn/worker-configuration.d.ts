/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: ce3b88d154bf104e2c0e33a0b8ac7227)
// Runtime types generated with workerd@1.20250617.0 2025-01-16 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		SUPABASE_URL: "https://dqofogasktmvjqcjaeyk.supabase.co";
		DO_TOKENLIST_NAME: string;
		ENVIRONMENT: string;
		LUMINA_TOKEN_ENDPOINT_AUTH_TOKEN: string;
		TOKENLIST: DurableObjectNamespace<import("./src/index").TokenList>;
		FETCHTOKEN: DurableObjectNamespace<import("./src/index").FetchToken>;
		CDN_BUCKET: R2Bucket;
