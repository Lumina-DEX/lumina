...
"undefined" == typeof window
	...
	: (() => {
			...
			r.serviceWorker &&
				...
				(r.serviceWorker.controller.postMessage({ type: "coepCredentialless", value: e.coepCredentialless() }),
							...
							r.serviceWorker.register(window.document.currentScript.src).then(
								(s) => {
									!e.quiet && console.log("COOP/COEP Service Worker registered", s.scope),
										...
										s.active &&
											!r.serviceWorker.controller &&
											(!e.quiet && console.log("Reloading page to make use of COOP/COEP Service Worker."), e.doReload())
								},
								(r) => {
