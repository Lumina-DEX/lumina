...
export type introspection_types = {
	...
	ActionFilterOptionsInput: {
		...
		inputFields: [
			...
			{ name: "tokenId"; type: { kind: "SCALAR"; name: "TokenId"; ofType: null }; defaultValue: null },
			{
				name: "address"
				type: { kind: "NON_NULL"; name: never; ofType: { kind: "SCALAR"; name: "PublicKey"; ofType: null } }
				defaultValue: null
			...
			actionData: {
				...
				type: {
					...
					ofType: {
						kind: "LIST"
						name: never
						ofType: { kind: "NON_NULL"; name: never; ofType: { kind: "OBJECT"; name: "ActionData"; ofType: null } }
					}
				}
			}
			actionState: {
			...
			eventData: {
				...
				type: {
					...
					ofType: {
						kind: "LIST"
						name: never
						ofType: { kind: "NON_NULL"; name: never; ofType: { kind: "OBJECT"; name: "EventData"; ofType: null } }
					}
				}
			}
		}
	...
	TransferRequestInput: {
		...
		inputFields: [
			{
				name: "direction"
				type: { kind: "NON_NULL"; name: never; ofType: { kind: "ENUM"; name: "TransferDirection"; ofType: null } }
				defaultValue: null
			},
			{
				name: "transfer"
				type: { kind: "NON_NULL"; name: never; ofType: { kind: "INPUT_OBJECT"; name: "TransferInput"; ofType: null } }
				defaultValue: null
			}
		]
	}
	...
	mutation: {
		...
		fields: {
			proveTransferClaim: {
				...
				type: { kind: "NON_NULL"; name: never; ofType: { kind: "OBJECT"; name: "ProveTransferPayload"; ofType: null } }
			}
	...
	query: {
		...
		fields: {
			...
			actions: {
				...
				type: {
					...
					ofType: {
						kind: "LIST"
						name: never
						ofType: { kind: "NON_NULL"; name: never; ofType: { kind: "OBJECT"; name: "ActionOutput"; ofType: null } }
					}
				}
			}
			daemonStatus: {
			...
			events: {
				...
				type: {
					...
					ofType: {
						kind: "LIST"
						name: never
						ofType: { kind: "NON_NULL"; name: never; ofType: { kind: "OBJECT"; name: "EventOutput"; ofType: null } }
					}
				}
			}
			feePerWeightUnit: {
				name: "feePerWeightUnit"
			...
			proverQueueSize: {
				name: "proverQueueSize"
				type: { kind: "NON_NULL"; name: never; ofType: { kind: "SCALAR"; name: "Int"; ofType: null } }
			}
			stateHashes: { name: "stateHashes"; type: { kind: "OBJECT"; name: "StateHashes"; ofType: null } }
			syncStatus: {
				name: "syncStatus"
			...
			transferAccountUpdate: { name: "transferAccountUpdate"; type: { kind: "SCALAR"; name: "String"; ofType: null } }
		}
	}
}
