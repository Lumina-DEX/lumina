...
const SIGNER_PRIVATE_KEY =
	Deno.env.get("SIGNER_PRIVATE_KEY") ?? "EKE9dyeMmvz6deCC2jD9rBk7d8bG6ZDqVno8wRe8tAbQDussfBYi"
const USER_O_PUBLIC_KEY =
	Deno.env.get("USER_O_PUBLIC_KEY") ?? "B62qrUAGW6S4pSBcZko2LdbUAhtLd15zVs9KtQedScBvwuZVbcnej35"
...
Deno.serve(async (request) => {
	try {
		...
		const mTransaction = createMeasure("Sign and Prove t	ransaction")
